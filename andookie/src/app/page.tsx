...
export default function Home() {
  ...
  const processTextInput = () => {
    ...
    setTimeout(() => {
      // Mock parsing of text input
      const parsedCards = mockCards.slice(0, 2); // Show fewer cards for text input
      setIdentifiedCards(parsedCards);
      setShowOffer(true);
      setLoading(false);
    }, 1500);
  };
